...
class _AltaRestState extends State<AltaRest> {
  ...
  /*final List<BasicForm> _horasLunes = [];
  final List<BasicForm> _horasMartes = [];
  final List<BasicForm> _horasMiercoles = [];
  final List<BasicForm> _horasJueves = [];
  final List<BasicForm> _horasViernes = [];
  final List<BasicForm> _horasSabado = [];
  final List<BasicForm> _horasDomingo = [];*/
