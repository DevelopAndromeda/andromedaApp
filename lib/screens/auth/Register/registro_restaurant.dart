...
class MyRegisterPageRestaurant extends StatefulWidget {
  const MyRegisterPageRestaurant({super.key});

  @override
  State<MyRegisterPageRestaurant> createState() => _MyRegisterPageRestaurant();
}

class _MyRegisterPageRestaurant extends State<MyRegisterPageRestaurant> {
  var firstname;
  var lastname;
  var email;
  var password;
