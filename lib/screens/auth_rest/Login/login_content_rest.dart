...
class LoginContentRest extends StatefulWidget {
  const LoginContentRest({super.key});

  @override
  State<LoginContentRest> createState() => _LoginContentRestState();
}

class _LoginContentRestState extends State<LoginContentRest> {
  var username;
  var password;
