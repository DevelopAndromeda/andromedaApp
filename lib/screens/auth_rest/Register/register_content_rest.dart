...
import 'package:andromeda/screens/auth_costum/Register/registro_viewmodel.dart';
import 'package:andromeda/Witgets/General/Button_Base.dart';

import 'package:andromeda/services/api.dart';
import 'package:andromeda/services/db.dart';

class RegisterContentRest extends StatefulWidget {
  const RegisterContentRest({super.key});

  @override
  State<RegisterContentRest> createState() => _RegisterContentRestState();
}

class _RegisterContentRestState extends State<RegisterContentRest> {
  var firstname;
  var lastname;
  var email;
  var password;
