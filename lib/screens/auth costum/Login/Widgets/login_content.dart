...
class loginContent extends StatefulWidget {
  ...
  _MyLoginContet createState() => _MyLoginContet();
}

class _MyLoginContet extends State<loginContent> {
//class loginContent extends StatelessWidget {
  var username;
  var password;
  //LoginViewModel vm;
  //_MyLoginContet(this.vm);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          const Spacer(), //Espacios de linea de codigo
          Container(
              alignment: Alignment.center,
              margin: const EdgeInsets.only(bottom: 20),
              child: const Text("¿No tienes cuenta?")),
