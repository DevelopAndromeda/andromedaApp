...
import 'package:andromeda/screens/auth%20costum/Login/login_state.dart';
...
class LoginViewModel extends ChangeNotifier {
  ...
  void changeEmail(String value) {
    ...
    if (!emailFormatValid) {
      ...
      _state = _state.copywith(
          email: ValidationItem(error: 'Al menos 6 caracteres minimos'));
    }
  ...
  void changePassword(String value) {
    if (value.length >= 6) {
      ...
      _state = _state.copywith(
          password: ValidationItem(error: 'Al menos 6 caracteres minimos'));
      notifyListeners();
    }
  }
