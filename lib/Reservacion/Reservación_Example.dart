...
class InfoRest extends StatefulWidget {
  @override
  _InfoRestState createState() => _InfoRestState();
}
...
class _InfoRestState extends State<InfoRest> {
  ...
  final String descripcion = "Descripción del restaurante. Aquí puedes agregar una descripción detallada de lo que ofrece el restaurante.";
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(labelText: 'Notas adicionales (opcional)'),
...
void main() => runApp(MaterialApp(home: InfoRest()));
